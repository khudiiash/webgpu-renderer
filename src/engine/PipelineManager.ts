...
export class PipelineManager {
  ...
  createRenderPipeline(params: {
    ...
    let { shader, layout, vertexLayouts = [], targets = [], renderState } = params;
    ...
    const fragmentModule = shader.fragmentSource ? this.createShaderModule("fs_" + shader.name, shader.fragmentSource) : undefined;
  ...
  createComputePipeline(params: { shader: Shader; name?: string; layout?: GPUPipelineLayout; entryPoint?: string }): GPUComputePipeline {
