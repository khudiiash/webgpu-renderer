...
class Color extends BufferData {
    ...
    constructor(...args: any) {
        ...
        if (args.length === 0 || args[0] === undefined || args[0] === null) {
            ...
            if (typeof args[0] === "string") {
                ...
                let offset = args[1] || 0;
                this[0] = args[0][offset] ?? 1;
                this[1] = args[0][offset + 1] ?? 1;
                this[2] = args[0][offset + 2] ?? 1;
                this[3] = args[0][offset + 3] ?? 1;
            }
    ...
    set r(value) {
        this[0] = value;
        this.monitor.check(0, 1);
    }
    set g(value) {
        this[1] = value;
        this.monitor.check(1, 2);
    }
    set b(value) {
        this[2] = value;
        this.monitor.check(2, 3);
    }
    set a(value) {
        this[3] = value;
        this.monitor.check(3, 4);
    }
    ...
    linearToSRGB() {
        ...
        this[0] = gammaCorrect(this.r);
        this[1] = gammaCorrect(this.g);
        this[2] = gammaCorrect(this.b);
        return this;
    }
    ...
    set(...args: any): this {
        if (args.length === 1) {
            ...
            super.set(args.map((v: number) => v ?? 1));
        }
        return this;
    }
