 ...
 * Originally converted to Javascript by Joseph Gentle.
 * Converted to TypeScript class by [Your Name].
 *
 * Version 2012-03-09
 *
...
export class Noise {
  ...
  /**
   * Seeds the noise function for consistent outputs
   * @param seed A number to use as the random seed
   */
  ...
  /**
   * Private helper function for perlin noise
   */
  ...
  /**
   * Private helper function for perlin noise - linear interpolation
   */
  ...
  perlin3(x: number, y: number, z: number): number {
    ...
    const n000 = this.gradP[xx + this.perm[yy + this.perm[zz]]].dot3(x, y, z);
    const n001 = this.gradP[xx + this.perm[yy + this.perm[zz + 1]]].dot3(x, y, z - 1);
    const n010 = this.gradP[xx + this.perm[yy + 1 + this.perm[zz]]].dot3(x, y - 1, z);
    const n011 = this.gradP[xx + this.perm[yy + 1 + this.perm[zz + 1]]].dot3(x, y - 1, z - 1);
    const n100 = this.gradP[xx + 1 + this.perm[yy + this.perm[zz]]].dot3(x - 1, y, z);
    const n101 = this.gradP[xx + 1 + this.perm[yy + this.perm[zz + 1]]].dot3(x - 1, y, z - 1);
    const n110 = this.gradP[xx + 1 + this.perm[yy + 1 + this.perm[zz]]].dot3(x - 1, y - 1, z);
    const n111 = this.gradP[xx + 1 + this.perm[yy + 1 + this.perm[zz + 1]]].dot3(x - 1, y - 1, z - 1);
